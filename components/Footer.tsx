...
const quickLinks = [
  ...
  { href: "#language", label: "Language Center" },
...
const destinations = ["United Kingdom", "Canada", "United States", "Australia", "Ireland", "Malta", "Finland", "Austria", "China", "Cyprus", "New Zealand"];
...
const socials = [
  ...
  // {
  //   name: "Twitter / X",
  //   href: "https://twitter.com/xlinksedconsult",
  //   icon: (
  //     <svg
  //       viewBox='0 0 24 24'
  //       fill='currentColor'
